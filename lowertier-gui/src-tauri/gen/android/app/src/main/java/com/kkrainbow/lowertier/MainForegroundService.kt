package com.kkrainbow.lowertier
...
class MainForegroundService : Service() {
    companion object {
        const val CHANNEL_ID = "lowertier_channel"
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        val notification = NotificationCompat.Builder(this, CHANNEL_ID)
            .setContentTitle("lowertier Running")
            .setContentText("lowertier is available on localhost")
