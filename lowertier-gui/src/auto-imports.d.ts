...
declare global {
  ...
  const getLowTierVersion: typeof import('./composables/backend')['getLowTierVersion']
...
declare module 'vue' {
  ...
  interface ComponentCustomProperties {
    ...
    readonly getLowTierVersion: UnwrapRef<typeof import('./composables/backend')['getLowTierVersion']>
