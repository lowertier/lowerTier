...
import { Api, NetworkTypes } from 'lowertier-frontend-lib'
import { GetNetworkMetasResponse } from 'node_modules/lowertier-frontend-lib/dist/modules/api'
...
export async function getLowTierVersion() {
  return await invoke<string>('lowertier_version')
}
