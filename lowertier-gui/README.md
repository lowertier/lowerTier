...
this is a GUI implementation for LowTier, based on Tauri2.
...
Java version depend on gradle version specified in (lowertier-gui\src-tauri\gen\android\build.gradle.kts)
