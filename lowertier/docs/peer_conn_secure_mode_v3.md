...
参考：[packet_def.rs](file:///data/project/LowTier/lowertier/src/tunnel/packet_def.rs#L59-L77)。
...
参考：[peer_manager.rs](file:///data/project/LowTier/lowertier/src/peers/peer_manager.rs#L361-L379)。
...
参考：[peer_manager.rs](file:///data/project/LowTier/lowertier/src/peers/peer_manager.rs#L361-L377)。
...
参考：[packet_def.rs:AesGcmTail](file:///data/project/LowTier/lowertier/src/tunnel/packet_def.rs#L266-L273)、[ring_chacha20.rs](file:///data/project/LowTier/lowertier/src/peers/encrypt/ring_chacha20.rs#L69-L93)。
...
来自 [packet_def.rs](file:///data/project/LowTier/lowertier/src/tunnel/packet_def.rs#L93-L105)：
...
来自 [packet_def.rs](file:///data/project/LowTier/lowertier/src/tunnel/packet_def.rs#L266-L273)：
...
[ring_chacha20.rs](file:///data/project/LowTier/lowertier/src/peers/encrypt/ring_chacha20.rs#L8-L16)。
...
```text
prologue = "lowertier-peerconn-noise"
```
...
[ring_chacha20.rs](file:///data/project/LowTier/lowertier/src/peers/encrypt/ring_chacha20.rs#L69-L93)
