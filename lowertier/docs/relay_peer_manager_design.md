...
- 发送内部路径：[peer_manager.rs:L1053-L1082](file:///data/project/LowTier/lowertier/src/peers/peer_manager.rs#L1053-L1082)
- 数据面发送入口：[peer_manager.rs:L1187-L1238](file:///data/project/LowTier/lowertier/src/peers/peer_manager.rs#L1187-L1238)
