...
import 'lowertier-frontend-lib/style.css'
import './style.css'
import App from './App.vue'
import LowTierFrontendLib from 'lowertier-frontend-lib'
import PrimeVue from 'primevue/config'
import Aura from '@primeuix/themes/aura';
import ConfirmationService from 'primevue/confirmationservice';
import { I18nUtils } from 'lowertier-frontend-lib'
...
).use(ToastService as any).use(DialogService as any).use(router).use(ConfirmationService as any).use(LowTierFrontendLib).mount('#app')
