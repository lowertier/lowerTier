...
const distPath = path.join(projectRoot, 'dist/lowertier-frontend-lib.js')
...
function allFieldFixture() {
  return {
    ...
    underlay_deny_cidrs: ['100.64.0.0/10'],
    ...
    credential_file: '/tmp/lowertier-credential.toml',
    lazy_p2p: true,
    need_p2p: true,
...
function assertFullFieldRoundTrip() {
  ...
  assert.equal(backend.quic_congestion, 'brutal')
