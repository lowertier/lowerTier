...
impl WebServerService for SessionRpcService {
    ...
    async fn get_feature(
        &self,
        _: BaseController,
        _: lowertier::proto::web::GetFeatureRequest,
    ) -> rpc_types::error::Result<lowertier::proto::web::GetFeatureResponse> {
        Ok(lowertier::proto::web::GetFeatureResponse {
            support_encryption: lowertier::web_client::security::web_secure_tunnel_supported(),
        })
    }
}
