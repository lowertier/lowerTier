...
use clap::Parser;
use lowertier::tunnel::websocket::WsTunnelListener;
use lowertier::{
    common::{
...
use lowertier::tunnel::IpScheme;
use lowertier::utils::BoxExt;
...
#[derive(Parser, Debug)]
#[command(name = "lowertier-web", author, version = LOWTIER_VERSION , about, long_about = None)]
struct Cli {
    #[arg(
        short,
        long,
...
pub struct WebhookOptions {
    ...
    /// Stable identifier for this lowertier-web instance when routing webhook callbacks.
    #[arg(long, env = "ET_WEB_INSTANCE_ID")]
    pub web_instance_id: Option<String>,

    /// Reachable base URL for this lowertier-web instance's internal REST API.
