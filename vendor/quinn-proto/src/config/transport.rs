...
/// Selects which queued DATAGRAM is discarded when the receive buffer is full.
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub enum DatagramReceiveDropPolicy {
    /// Discard queued DATAGRAMs before accepting the new DATAGRAM.
    #[default]
    Oldest,
    /// Discard the new DATAGRAM and preserve the queued receive prefix.
    Newest,
}
...
pub struct TransportConfig {
    ...
    pub(crate) datagram_receive_drop_policy: DatagramReceiveDropPolicy,
...
impl TransportConfig {
    ...
    /// Select which DATAGRAM is discarded when the receive buffer is full.
    pub fn datagram_receive_drop_policy(&mut self, value: DatagramReceiveDropPolicy) -> &mut Self {
        self.datagram_receive_drop_policy = value;
        self
    }
...
impl Default for TransportConfig {
    fn default() -> Self {
        ...
        Self {
            ...
            datagram_receive_drop_policy: DatagramReceiveDropPolicy::Oldest,
...
impl fmt::Debug for TransportConfig {
    fn fmt(&self, fmt: &mut fmt::Formatter<'_>) -> fmt::Result {
        ...
        s.field("max_concurrent_bidi_streams", max_concurrent_bidi_streams)
            ...
            .field("datagram_receive_drop_policy", datagram_receive_drop_policy)
