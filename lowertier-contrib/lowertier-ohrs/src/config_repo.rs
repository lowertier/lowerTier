...
pub(crate) const CONFIG_DIR_NAME: &str = "lowertier-configs";
pub(crate) const KERNEL_SOCKET_FILE_NAME: &str = "lowertier-kernel.sock";
...
mod tests {
    ...
    fn test_root() -> String {
        let unique = SystemTime::now()
            ...
            .unwrap()
            .as_nanos();
        let dir = std::env::temp_dir().join(format!("lowertier_ohrs_test_{}", unique));
