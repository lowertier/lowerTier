...
const SOCKET_ADDR_CLASS: &str = "com/lowertier/jni/DataPlaneSocketAddress";
const TCP_CONNECT_RESULT_CLASS: &str = "com/lowertier/jni/DataPlaneTcpConnectResult";
const TCP_BIND_RESULT_CLASS: &str = "com/lowertier/jni/DataPlaneTcpBindResult";
const TCP_ACCEPT_RESULT_CLASS: &str = "com/lowertier/jni/DataPlaneTcpAcceptResult";
const TCP_READ_RESULT_CLASS: &str = "com/lowertier/jni/DataPlaneTcpReadResult";
const UDP_BIND_RESULT_CLASS: &str = "com/lowertier/jni/DataPlaneUdpBindResult";
const UDP_RECV_RESULT_CLASS: &str = "com/lowertier/jni/DataPlaneUdpRecvResult";
...
fn throw_last(env: &mut JNIEnv) {
    let message = get_last_error().unwrap_or_else(|| "LowTier data-plane call failed".to_string());
