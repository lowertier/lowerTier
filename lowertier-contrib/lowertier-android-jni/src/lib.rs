//! JNI facade for Android callers of LowTier.
//!
//! This file intentionally lists every Java-visible native method exported by
//! `liblowertier_android_jni.so`. The implementation details live in sibling
...
//! - `callJsonRpc(...)`: call an exposed LowTier RPC service with JSON payload.
//!
...
//!
//! Data-plane APIs:
//! - `LowTierDataPlaneJNI.*`: low-level async op-handle data-plane JNI.
//! - `LowTierJNI.dataPlane*`: compatibility exports for older callers.
...
/// Attach a TUN file descriptor to an LowTier network instance.
///
/// Java signature:
/// `LowTierJNI.setTunFd(instanceName: String, fd: Int): Int`
///
...
/// one is available.
#[unsafe(no_mangle)]
pub extern "system" fn Java_com_lowertier_jni_LowTierJNI_setTunFd(
    env: JNIEnv,
    class: JClass,
    inst_name: JString,
    fd: jint,
...
///
/// Java signature:
/// `LowTierJNI.parseConfig(config: String): Int`
///
...
#[unsafe(no_mangle)]
pub extern "system" fn Java_com_lowertier_jni_LowTierJNI_parseConfig(
    env: JNIEnv,
    class: JClass,
    config: JString,
) -> jint {
...
/// Start one local LowTier network instance from TOML config text.
///
/// Java signature:
/// `LowTierJNI.runNetworkInstance(config: String): Int`
///
...
#[unsafe(no_mangle)]
pub extern "system" fn Java_com_lowertier_jni_LowTierJNI_runNetworkInstance(
    env: JNIEnv,
    class: JClass,
    config: JString,
) -> jint {
...
///
/// Java signature:
/// `LowTierJNI.retainNetworkInstance(instanceNames: Array<String>?): Int`
///
...
/// `RuntimeException`.
#[unsafe(no_mangle)]
pub extern "system" fn Java_com_lowertier_jni_LowTierJNI_retainNetworkInstance(
    env: JNIEnv,
    class: JClass,
...
///
/// Java signature:
/// `LowTierJNI.collectNetworkInfos(maxLength: Int): String?`
///
...
#[unsafe(no_mangle)]
pub extern "system" fn Java_com_lowertier_jni_LowTierJNI_collectNetworkInfos(
    env: JNIEnv,
    class: JClass,
    max_length: jint,
) -> jstring {
...
///
/// Java signature:
/// `LowTierJNI.listInstances(maxLength: Int): String?`
///
...
/// `RuntimeException`.
#[unsafe(no_mangle)]
pub extern "system" fn Java_com_lowertier_jni_LowTierJNI_listInstances(
    env: JNIEnv,
    class: JClass,
    max_length: jint,
) -> jstring {
...
/// Call an exposed LowTier RPC method using protobuf JSON.
///
/// Java signature:
/// `LowTierJNI.callJsonRpc(serviceName, methodName, domainName, payloadJson): String?`
///
/// Instance lifecycle management RPCs are intentionally not exposed here. Use
/// the dedicated LowTierJNI instance APIs for start/retain/delete/collect.
...
#[unsafe(no_mangle)]
pub extern "system" fn Java_com_lowertier_jni_LowTierJNI_callJsonRpc(
    env: JNIEnv,
    class: JClass,
...
///
/// Java signature:
/// `LowTierJNI.getLastError(): String?`
///
...
#[unsafe(no_mangle)]
pub extern "system" fn Java_com_lowertier_jni_LowTierJNI_getLastError(
    env: JNIEnv,
    class: JClass,
) -> jstring {
...
///
/// Java signature:
/// `LowTierJNI.startConfigServerClient(url, hostname, machineId, secureMode, callback): Int`
///
...
/// On failure this returns `-1` and throws `RuntimeException`.
#[unsafe(no_mangle)]
pub extern "system" fn Java_com_lowertier_jni_LowTierJNI_startConfigServerClient(
    mut env: JNIEnv,
    _class: JClass,
...
///
/// Java signature:
/// `LowTierJNI.stopConfigServerClient(): Int`
///
...
#[unsafe(no_mangle)]
pub extern "system" fn Java_com_lowertier_jni_LowTierJNI_stopConfigServerClient(
    env: JNIEnv,
    class: JClass,
) -> jint {
    logger::init();
...
///
/// Java signature:
/// `LowTierJNI.isConfigServerClientConnected(): Boolean`
///
/// Returns `JNI_TRUE` only when the FFI config-server client exists and reports
/// connected.
#[unsafe(no_mangle)]
pub extern "system" fn Java_com_lowertier_jni_LowTierJNI_isConfigServerClientConnected(
    env: JNIEnv,
    class: JClass,
) -> jboolean {
    logger::init();
...
export_data_plane_jni!(
    Java_com_lowertier_jni_LowTierDataPlaneJNI_dataPlaneAsyncOpStatus,
    Java_com_lowertier_jni_LowTierDataPlaneJNI_dataPlaneAsyncOpWait,
    Java_com_lowertier_jni_LowTierDataPlaneJNI_dataPlaneAsyncOpCancel,
    Java_com_lowertier_jni_LowTierDataPlaneJNI_dataPlaneAsyncOpFree,
    Java_com_lowertier_jni_LowTierDataPlaneJNI_dataPlaneTcpConnectStart,
    Java_com_lowertier_jni_LowTierDataPlaneJNI_dataPlaneTcpConnectFinish,
    Java_com_lowertier_jni_LowTierDataPlaneJNI_dataPlaneTcpBindStart,
    Java_com_lowertier_jni_LowTierDataPlaneJNI_dataPlaneTcpBindFinish,
    Java_com_lowertier_jni_LowTierDataPlaneJNI_dataPlaneTcpAcceptStart,
    Java_com_lowertier_jni_LowTierDataPlaneJNI_dataPlaneTcpAcceptFinish,
    Java_com_lowertier_jni_LowTierDataPlaneJNI_dataPlaneTcpReadStart,
    Java_com_lowertier_jni_LowTierDataPlaneJNI_dataPlaneTcpReadFinish,
    Java_com_lowertier_jni_LowTierDataPlaneJNI_dataPlaneTcpWriteStart,
    Java_com_lowertier_jni_LowTierDataPlaneJNI_dataPlaneTcpWriteFinish,
    Java_com_lowertier_jni_LowTierDataPlaneJNI_dataPlaneUdpBindStart,
    Java_com_lowertier_jni_LowTierDataPlaneJNI_dataPlaneUdpBindFinish,
    Java_com_lowertier_jni_LowTierDataPlaneJNI_dataPlaneUdpSendToStart,
    Java_com_lowertier_jni_LowTierDataPlaneJNI_dataPlaneUdpSendToFinish,
    Java_com_lowertier_jni_LowTierDataPlaneJNI_dataPlaneUdpRecvFromStart,
    Java_com_lowertier_jni_LowTierDataPlaneJNI_dataPlaneUdpRecvFromFinish,
    Java_com_lowertier_jni_LowTierDataPlaneJNI_dataPlaneTcpClose,
    Java_com_lowertier_jni_LowTierDataPlaneJNI_dataPlaneTcpListenerClose,
    Java_com_lowertier_jni_LowTierDataPlaneJNI_dataPlaneUdpClose
);

// Compatibility exports for older Kotlin/Java callers that used LowTierJNI
// directly for data-plane operations.

#[unsafe(no_mangle)]
pub extern "system" fn Java_com_lowertier_jni_LowTierJNI_dataPlaneAsyncOpStatus(
    env: JNIEnv,
    class: JClass,
    handle: jlong,
) -> jint {
...
#[unsafe(no_mangle)]
pub extern "system" fn Java_com_lowertier_jni_LowTierJNI_dataPlaneAsyncOpWait(
    env: JNIEnv,
    class: JClass,
    handle: jlong,
    timeout_ms: jlong,
...
#[unsafe(no_mangle)]
pub extern "system" fn Java_com_lowertier_jni_LowTierJNI_dataPlaneAsyncOpCancel(
    env: JNIEnv,
    class: JClass,
    handle: jlong,
) -> jint {
...
#[unsafe(no_mangle)]
pub extern "system" fn Java_com_lowertier_jni_LowTierJNI_dataPlaneAsyncOpFree(
    env: JNIEnv,
    class: JClass,
    handle: jlong,
) -> jint {
...
#[unsafe(no_mangle)]
pub extern "system" fn Java_com_lowertier_jni_LowTierJNI_dataPlaneTcpConnectStart(
    env: JNIEnv,
    class: JClass,
    inst_name: JString,
    dst_ip: JString,
...
#[unsafe(no_mangle)]
pub extern "system" fn Java_com_lowertier_jni_LowTierJNI_dataPlaneTcpConnectFinish(
    env: JNIEnv,
    class: JClass,
    op: jlong,
) -> jobject {
...
#[unsafe(no_mangle)]
pub extern "system" fn Java_com_lowertier_jni_LowTierJNI_dataPlaneTcpBindStart(
    env: JNIEnv,
    class: JClass,
    inst_name: JString,
    local_port: jint,
...
#[unsafe(no_mangle)]
pub extern "system" fn Java_com_lowertier_jni_LowTierJNI_dataPlaneTcpBindFinish(
    env: JNIEnv,
    class: JClass,
    op: jlong,
) -> jobject {
...
#[unsafe(no_mangle)]
pub extern "system" fn Java_com_lowertier_jni_LowTierJNI_dataPlaneTcpAcceptStart(
    env: JNIEnv,
    class: JClass,
    handle: jlong,
    timeout_ms: jlong,
...
#[unsafe(no_mangle)]
pub extern "system" fn Java_com_lowertier_jni_LowTierJNI_dataPlaneTcpAcceptFinish(
    env: JNIEnv,
    class: JClass,
    op: jlong,
) -> jobject {
...
#[unsafe(no_mangle)]
pub extern "system" fn Java_com_lowertier_jni_LowTierJNI_dataPlaneTcpReadStart(
    env: JNIEnv,
    class: JClass,
    handle: jlong,
    max_len: jint,
...
#[unsafe(no_mangle)]
pub extern "system" fn Java_com_lowertier_jni_LowTierJNI_dataPlaneTcpReadFinish(
    env: JNIEnv,
    class: JClass,
    op: jlong,
) -> jobject {
...
#[unsafe(no_mangle)]
pub extern "system" fn Java_com_lowertier_jni_LowTierJNI_dataPlaneTcpWriteStart(
    env: JNIEnv,
    class: JClass,
    handle: jlong,
    data: JByteArray,
...
#[unsafe(no_mangle)]
pub extern "system" fn Java_com_lowertier_jni_LowTierJNI_dataPlaneTcpWriteFinish(
    env: JNIEnv,
    class: JClass,
    op: jlong,
) -> jint {
...
#[unsafe(no_mangle)]
pub extern "system" fn Java_com_lowertier_jni_LowTierJNI_dataPlaneUdpBindStart(
    env: JNIEnv,
    class: JClass,
    inst_name: JString,
    local_port: jint,
...
#[unsafe(no_mangle)]
pub extern "system" fn Java_com_lowertier_jni_LowTierJNI_dataPlaneUdpBindFinish(
    env: JNIEnv,
    class: JClass,
    op: jlong,
) -> jobject {
...
#[unsafe(no_mangle)]
pub extern "system" fn Java_com_lowertier_jni_LowTierJNI_dataPlaneUdpSendToStart(
    env: JNIEnv,
    class: JClass,
    handle: jlong,
    dst_ip: JString,
...
#[unsafe(no_mangle)]
pub extern "system" fn Java_com_lowertier_jni_LowTierJNI_dataPlaneUdpSendToFinish(
    env: JNIEnv,
    class: JClass,
    op: jlong,
) -> jint {
...
#[unsafe(no_mangle)]
pub extern "system" fn Java_com_lowertier_jni_LowTierJNI_dataPlaneUdpRecvFromStart(
    env: JNIEnv,
    class: JClass,
    handle: jlong,
    max_len: jint,
...
#[unsafe(no_mangle)]
pub extern "system" fn Java_com_lowertier_jni_LowTierJNI_dataPlaneUdpRecvFromFinish(
    env: JNIEnv,
    class: JClass,
    op: jlong,
) -> jobject {
...
#[unsafe(no_mangle)]
pub extern "system" fn Java_com_lowertier_jni_LowTierJNI_dataPlaneTcpClose(
    env: JNIEnv,
    class: JClass,
    handle: jlong,
) -> jint {
...
#[unsafe(no_mangle)]
pub extern "system" fn Java_com_lowertier_jni_LowTierJNI_dataPlaneTcpListenerClose(
    env: JNIEnv,
    class: JClass,
    handle: jlong,
) -> jint {
...
#[unsafe(no_mangle)]
pub extern "system" fn Java_com_lowertier_jni_LowTierJNI_dataPlaneUdpClose(
    env: JNIEnv,
    class: JClass,
    handle: jlong,
) -> jint {
