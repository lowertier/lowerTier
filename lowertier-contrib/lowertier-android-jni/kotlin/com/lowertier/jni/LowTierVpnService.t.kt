...
class LowTierVpnService : VpnService() {
    ...
    companion object {
        private const val TAG = "LowTierVpnService"
    }
    ...
    private fun setupVpnInterface(ipv4Address: String, proxyCidrs: List<String>) {
        try {
            ...
            builder.setSession("LowTier VPN")
                    ...
                    .addDisallowedApplication("com.lowertier.lowertiervpn")
            ...
            // 4. 将 TUN 文件描述符传递给 LowTier
            instanceName?.let { name ->
                val fd = vpnInterface!!.fd
                val result = LowTierJNI.setTunFd(name, fd)
                if (result == 0) {
