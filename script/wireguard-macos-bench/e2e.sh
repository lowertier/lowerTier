...
image=${WIREGUARD_TEST_IMAGE:-lowertier-wireguard-bench:local}
build_image=${BUILD_IMAGE:-1}
host_udp_port=${HOST_UDP_PORT:-12020}
container_name=lowertier-wireguard-macos-bench
result_dir=${RESULT_DIR:-$(mktemp -d -t lowertier-wireguard-macos-bench.XXXXXX)}
...
wireguard_go_binary=${WIREGUARD_GO_BINARY:-/tmp/lowertier-wireguard-go-$wireguard_go_revision}
